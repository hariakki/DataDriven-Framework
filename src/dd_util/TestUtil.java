...
public static String mailscreenshotpath;
	...
	public static boolean isExecutable(String tcid){
		...
		for(int rowNum=2; rowNum<=excel.getRowCount("testdata"); rowNum++){
			
			if(excel.getCellData("testdata", "TCID", rowNum).equals(tcid)){
				if(excel.getCellData("testdata", "runmode", rowNum).equalsIgnoreCase("Y")){
